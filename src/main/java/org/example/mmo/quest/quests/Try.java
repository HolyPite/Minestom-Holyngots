...
public final class Try {
    ...
    static {
        ...
        s1.objectives = List.of(
                new TalkObjective("guide", Component.text("Parler au Guide"), List.of(Component.text("Ah, un nouvel aventurier ! J'ai quelque chose pour vous...")))
        );
        ...
        s2.objectives = List.of(
                new FetchObjective(Excalibur.INSTANCE, 1, Component.text("Trouver Excalibur"))
        );
        ...
        // Step 3: The reward (just talking)
        ...
        s3.startNpc = "guide";
        s3.endNpc = "guide";
        s3.objectives = List.of(
                new TalkObjective("guide", Component.text("Recevoir la récompense"), List.of(Component.text("Portez-la avec honneur.")))
        );
        s3.rewards = List.of(
