...
public final class MobArchetype {
    ...
    private final MobQuestLootTable questLootTable;
    ...
    private MobArchetype(Builder builder) {
        ...
        this.questLootTable = builder.questLootTable != null ? builder.questLootTable : MobQuestLootTable.EMPTY;
    ...
    public MobQuestLootTable questLootTable() {
        return questLootTable;
    }
    ...
    public static final class Builder {
        ...
        private MobQuestLootTable questLootTable;
        ...
        public Builder questLootTable(MobQuestLootTable questLootTable) {
            this.questLootTable = questLootTable;
            return this;
        }
