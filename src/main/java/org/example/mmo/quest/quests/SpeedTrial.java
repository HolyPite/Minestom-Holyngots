...
public final class SpeedTrial {
    ...
    static {
        ...
        step2.objectives = List.of(
                new LocationObjective(new Pos(20, 40, 20), 3, Component.text("Atteignez le cercle au sommet de la colline")), // First objective
                new LocationObjective(new Pos(-20, 40, -20), 3, Component.text("Atteignez le cercle dans la vallée")) // Second objective
        );
        step2.duration = Duration.ofMinutes(1); // Increased to 1 minute
