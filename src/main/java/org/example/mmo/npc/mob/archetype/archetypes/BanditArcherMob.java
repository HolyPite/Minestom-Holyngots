...
import org.example.mmo.npc.mob.ai.ais.ArcherAiFactory;
import org.example.mmo.npc.mob.behaviour.behaviours.EquipItemBehaviour;
import org.example.mmo.npc.mob.loot.loots.BanditArcherLoot;
...
public final class BanditArcherMob {
    ...
    private static MobArchetype create() {
        return MobArchetype.builder(ID, NAME, EntityType.SKELETON)
                ...
                .aiFactory(new ArcherAiFactory(30, 30, 12, 1.6, 0.12))
