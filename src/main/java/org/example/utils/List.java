...
public final class List {
    ...
    /** Béton plein (16) */
    public static final Material[] CONCRETES = {
    ...
    public static final Material[] FLUIDS = {
            Material.WATER_BUCKET, Material.LAVA_BUCKET//, Material.MILK_BUCKET, Material.POWDER_SNOW_BUCKET
    };
}
